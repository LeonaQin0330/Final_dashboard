...
# Combine plots
hct_subplot <- subplot(normal_weight_plot, overweight_plot, obese_plot, nrows = 3, shareX = TRUE, shareY = TRUE) %>%
  layout(
...
Users can toggle the visibility of different BMI categories by clicking on the legend. Hovering over any bin of the histogram will display a tooltip showing the BMI Category, the Hematocrit (%) range, and the count of patients in that bin.
...
[🔗 View Source Code on GitHub](https://github.com/LeonaQin0330/Final_dashboard)
